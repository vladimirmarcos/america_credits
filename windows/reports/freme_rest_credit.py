...
import models
from models.reports_dao import create_reports_rest_credit, create_reports_rest_credit_excel

from .frame_reports import FrameReports
class FrameReportsRestCredit(FrameReports):
    ...
    def generate_reports_excel(self):
        ...
        create_reports_rest_credit_excel(fecha_texto_1,date_1)
